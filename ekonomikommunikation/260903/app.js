...
(function () {
  ...
  var DATA = {
    ...
    B: {
      fromX: {
        kol: ["X", "X+1", "X+2", "X+3", "X+4"],
        intakter: [r5(1000), r5(2000), r5(1100), [3000, 3000, 3000, 3000, 0], [500, 500, 500, 0, 0], [700, 0, 0, 0, 0], [1800, 0, 0, 0, 0]],
        kostnader: KOST_X
      },
      fromX1: {
        kol: ["X+1", "X+2", "X+3", "X+4", "X+5"],
    ...
    C: {
      fromX: {
        kol: ["X", "X+1", "X+2", "X+3", "X+4"],
        intakter: [r5(1000), r5(2000), [1100, 1100, 1100, 1100, 0], [3000, 3000, 3000, 0, 0], [500, 500, 500, 500, 0], [700, 0, 0, 0, 0], [1800, 0, 0, 0, 0]],
        kostnader: KOST_X
      },
      fromX1: {
        kol: ["X+1", "X+2", "X+3", "X+4", "X+5"],
    ...
    D: {
      fromX: {
        kol: ["X", "X+1", "X+2", "X+3", "X+4"],
        intakter: [[1000, 1000, 1000, 1000, 0], [2000, 2000, 2000, 2000, 0], [1100, 1100, 0, 0, 0], [3000, 3000, 0, 0, 0], [500, 0, 0, 0, 0], [700, 0, 0, 0, 0], [1800, 0, 0, 0, 0]],
        kostnader: KOST_X
      },
      fromX1: {
        kol: ["X+1", "X+2", "X+3", "X+4", "X+5"],
